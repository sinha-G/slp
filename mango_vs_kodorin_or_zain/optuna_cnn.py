...
def objective(trial, dataloaders, study_name):
    ...
    def evaluate_test(model, dataloader, criterion, study_name):
        ...
        confusion_matrix_path = 'data\\mango_vs_kodorin_or_zain\\confusion_matrices\\' + study_name + '\\'
        ...
        with torch.no_grad():  # No gradients needed
            ...
            sns.heatmap(cm, annot=True, fmt='f', cmap='Blues', xticklabels=labels, yticklabels=labels)
...
def main():
    ...
    # Set Some Variables
    study_name = current_datetime_string + "Basic CNN - Classify Mango vs Kodorin or Zain"
    batch_size = 32

    # Set up logging file
    log_file = 'data\\mango_vs_kodorin_or_zain\\logs\\' + study_name + ' Log.txt'
